...
export default function Question() {
  ...
  function ShowAnswerBtn() {
    ...
    return (
      <div>
        {isOpen && <AnswerBox />}
        <button onClick={toggle} className="bg-primary border-[2px] border-full border-accent rounded-lg p-4 text-secondary font-bubble tracking-wider text-2xl mt-4">{buttonText}</button>
      </div>
    );
  }
  return (
